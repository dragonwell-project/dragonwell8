...
[
  ...
  LEGACY_HOST_LDFLAGS="$LEGACY_HOST_LDFLAGS $with_extra_ldflags $DRAGONWELL_EXTRA_LDFLAGS"
  LEGACY_TARGET_LDFLAGS="$LEGACY_TARGET_LDFLAGS $with_extra_ldflags $DRAGONWELL_EXTRA_LDFLAGS"
