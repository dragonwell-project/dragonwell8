...
public class JvmtiAddPath {
    ...
    static String[] check_appcds_enabled = {
        "[Loaded ExtraClass from shared objects"
    };
    static String[] check_appcds_disabled = {
        "ExtraClass from file:"
    };
    ...
    public static void main(String[] args) throws Exception {
        ...
        run(check_appcds_enabled, appJar, "-XX:+TraceClassLoading", "JvmtiApp", "noadd"); // appcds should be enabled

        System.out.println("Test case 2: add to boot classpath only - should find Hello.class in boot loader");
        run(check_appcds_disabled, appJar, "-XX:+TraceClassLoading", "JvmtiApp", "bootonly", addbootJar); // appcds should be disabled
