    ...
    public KeyStore.Entry engineGetEntry(String alias, KeyStore.ProtectionParameter protParam)
        ...
        if (engineIsCertificateEntry(alias)) {
            ...
            if (entry instanceof TrustedCertEntry) {
                ...
                Set<KeyStore.Entry.Attribute> attrs = new HashSet<KeyStore.Entry.Attribute>(){{
                    add(new LocalAttr(KnownOIDs.ORACLE_TrustedKeyUsage.value(), tEntry.trustedKeyUsageValue));
                    add(new LocalAttr("trustSettings", tEntry.trustSettings.toString()));
                }};

                return new KeyStore.TrustedCertificateEntry(
                        tEntry.cert, Collections.unmodifiableSet(attrs));
            }
        }
    ...
    private void createTrustedCertEntry(String alias, List<String> inputTrust,
        ...
        try {
            ...
            if (tce.trustSettings.isEmpty()) {
                ...
                for (Map<String, String> oneTrust : tce.trustSettings) {
