...
public final class RecordedFrame extends RecordedObject {
     ...
     * this recorded frame.
     *
     * @return byte code index, or {@code -1} if not available
     */
     ...
     * recorded frame, or {@code -1} if not available.
     *
     * @return the line number, or {@code -1} if not available
     */
     ...
     * {@code "Inlined"}).
     *
     * @return the frame type, or {@code null} if not available
     */
