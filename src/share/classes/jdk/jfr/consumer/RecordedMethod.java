...
public final class RecordedMethod extends RecordedObject {
    ...
    /**
     * Returns the class this method belongs to, or {@code null} if this method
     * doesn't belong to a Java frame.
     *
     * @return the class, or {@code null} if this method doesn't belong
     *         to a Java frame.
     *
     ...
     *
     * @return method name, or {@code null} not available
     *
     * @see RecordedFrame#isJavaFrame()
     */
