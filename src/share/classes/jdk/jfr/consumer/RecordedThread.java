...
public final class RecordedThread extends RecordedObject {
     ...
     *
     * @return the OS thread name, or {@code null} if not available
     */
     ...
     *
     * @return The Java thread ID, or {@code -1} if not available
     */
     ...
     *
     * @return the thread group, or {@code null} if not available
     */
    ...
    /**
     * Returns the Java thread name, or {@code null} if not available.
     * <p>
     * Returns {@code java.lang.Thread.getName()} if the thread has a Java
     * representation. {@code null} otherwise.
     *
     * @return the Java thread name, or {@code null} if not available
     */
