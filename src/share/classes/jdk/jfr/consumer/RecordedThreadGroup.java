...
public final class RecordedThreadGroup extends RecordedObject {
    ...
    /**
     * Returns the name of the thread group, or {@code null} if not available.
     *
     * @return the thread group name, or {@code null} if not available
     */
    ...
    /**
     * Returns the parent thread group, or {@code null} if not available.
     *
     * @return parent thread group, or {@code null} if not available
     */
