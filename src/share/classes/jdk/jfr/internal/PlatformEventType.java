...
public final class PlatformEventType extends Type {
    ...
    PlatformEventType(String name, long id, boolean isJDK, boolean dynamicSettings) {
        ...
        this.isMethodSampling = name.equals(Type.ORACLE_EVENT_PREFIX + "ExecutionSample") || name.equals(Type.ORACLE_EVENT_PREFIX + "NativeMethodSample");
        this.isJDK = isJDK;
    ...
    private static int stackTraceOffset(String name, boolean isJDK) {
        if (isJDK) {
            if (name.equals(Type.ORACLE_EVENT_PREFIX + "JavaExceptionThrow")) {
                return 5;
            }
            if (name.equals(Type.ORACLE_EVENT_PREFIX + "JavaErrorThrow")) {
                return 5;
            }
        }
        return 4;
