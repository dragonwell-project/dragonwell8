...
public class Type implements Comparable<Type> {
    ...
    public static final String ORACLE_EVENT_PREFIX = "com.oracle.jdk.";
    public static final String ORACLE_TYPE_PREFIX = "com.oracle.jfr.types.";
    ...
    static final Type STACK_TRACE = register(null, new Type(ORACLE_TYPE_PREFIX + "StackTrace", null, 23));
     ...
     * Creates a type
     *
     * @param javaTypeName i.e "com.oracle.jfr.type.StackFrame"
     * @param superType i.e "com.oracle.jfr.Event" and "java.lang.Annotation"
    ...
    public static Class<?> getKnownType(String className) {
        for (Map.Entry<Type, Class<?>> entry : knownTypes.entrySet()) {
            Class<?> clazz = entry.getValue();
            if (clazz != null) {
                String knownClassName = clazz.getName();
