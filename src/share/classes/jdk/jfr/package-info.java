 ...
 * available in the <code>jdk.jfr.annotation</code> package, or by using a
 ...
 * instance would actually be written to the system when commit is invoked. If
 ...
 * <td>ISpecifies the interval at which the event is emitted, if it is
 * periodic</td>
