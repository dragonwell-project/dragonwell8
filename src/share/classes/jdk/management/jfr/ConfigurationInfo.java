...
public final class ConfigurationInfo {
    ...
    /**
     * Returns the configuration provider, for example {@code "Oracle"}.
     *
     * @return the provider, or {@code null} if not available
     *
     ...
     *
     * @return contents, or {@code null} if not available
     *
     ...
     *
     * @return map with settings, not {@code null}
     *
    ...
    /**
     * Returns the human-readable name, for example {@code "Continuous"}. for
     * the configuration associated with this {@code ConfigurationInfo}
     *
     * @return the label, or {@code null} if not available
     *
    ...
    /**
     * Returns a sentence or two, describing the configuration associated with
     ...
     * {@code ConfigurationInfo} instance.s
     *
