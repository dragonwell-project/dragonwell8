...
public final class EventTypeInfo {
     ...
     * for this {@link EventTypeInfo}, for example {@code "Garbage Collection"}.
     *
     * @return the label
     *
    ...
    /**
     *
     * Returns the list of human-readable names that makes up the category for
     * this event type, for instance "Java Virtual Machine",
     * "Garbage Collector".
     *
     * @return an immutable list of category names, or a list with the name
     *         "Uncategorized" if no category has been set
     *
    ...
    /**
     * Returns the unique numeric id for the event type associated with this
     * {@link EventTypeInfo}, not guaranteed to be the same for different JVM
     * instances.
     *
     * @return the id
     *
     ...
     * {@link EventTypeInfo}, for example
     * {@code "com.oracle.jdk.GarbageCollection"}.
     *
     * @return the name
     *
