...
#ifndef SHARE_VM_JFR_RECORDER_ACCESS_JFROPTIONSET_HPP
#define SHARE_VM_JFR_RECORDER_ACCESS_JFROPTIONSET_HPP
...
class JfrOptionSet : public AllStatic {
 ...
 public:
  ...
  static bool parse_start_flight_recording(const JavaVMOption** option, char* tail);
  static bool parse_flight_recorder_options(const JavaVMOption** option, char* tail);

};

#endif // SHARE_VM_JFR_RECORDER_ACCESS_JFROPTIONSET_HPP
