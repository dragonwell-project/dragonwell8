...
#ifndef SHARE_VM_JFR_RECORDER_CHECKPOINT_CONSTANT_JFRTAGSET_HPP
#define SHARE_VM_JFR_RECORDER_CHECKPOINT_CONSTANT_JFRTAGSET_HPP
...
class JfrTagSet : AllStatic {
  friend class ConstantTagSet;
  friend class JfrConstantManager;
 ...
 private:
  ...
  static void write(JfrCheckpointWriter* writer, JfrCheckpointWriter* leakp_writer, bool class_unload);
};

#endif // SHARE_VM_JFR_RECORDER_CHECKPOINT_CONSTANT_JFRTAGSET_HPP
