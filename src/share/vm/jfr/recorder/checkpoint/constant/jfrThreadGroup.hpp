...
#ifndef SHARE_VM_JFR_RECORDER_CHECKPOINT_CONSTANT_JFRTHREADGROUP_HPP
#define SHARE_VM_JFR_RECORDER_CHECKPOINT_CONSTANT_JFRTHREADGROUP_HPP
...
class JfrThreadGroup : public JfrCHeapObj {
 ...
 public:
  ...
  static void write(JfrCheckpointWriter* w, traceid thread_group_id);
  static traceid thread_group_id(const JavaThread* thread, Thread* current);
  static void write(JfrCheckpointWriter& w);
};

#endif // SHARE_VM_JFR_RECORDER_CHECKPOINT_CONSTANT_JFRTHREADGROUP_HPP
