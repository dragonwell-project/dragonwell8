...
#ifndef SHARE_VM_JFR_CHECKPOINT_CONSTANT_TRACEID_JFRTYPEIDS_INLINE_HPP
#define SHARE_VM_JFR_CHECKPOINT_CONSTANT_TRACEID_JFRTYPEIDS_INLINE_HPP

#include "jfr/recorder/checkpoint/constant/traceid/jfrTraceIdMacros.hpp"
...
inline traceid JfrTraceId::get(const Thread* t) {
  ...
  return TRACE_ID_RAW(t->trace_data());
}
...
#endif // SHARE_VM_JFR_CHECKPOINT_CONSTANT_TRACEID_JFRTYPEIDS_INLINE_HPP
