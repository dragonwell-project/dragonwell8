...
class JfrCheckpointWriter : public JfrCheckpointWriterBase {
 ...
 public:
  ...
  ~JfrCheckpointWriter();
  void write_constant_type(JfrConstantTypeId constant_type_id);
  void write_number_of_constants(u4 nof_entries);
  void write_number_of_constants(u4 nof_entries, jlong offset);
