...
import jdk.testlibrary.jfr.ObjectCountAfterGCEvent;
import jdk.testlibrary.jfr.ObjectCountEventVerifier;
...
public class TestObjectCountAfterGCEventWithG1FullCollection {
    public static void main(String[] args) throws Exception {
        ...
        // g1 full gc is serial old in jdk8
        ObjectCountAfterGCEvent.test("SerialOld");
    }
}
