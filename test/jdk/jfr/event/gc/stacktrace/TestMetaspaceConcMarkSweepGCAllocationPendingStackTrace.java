...
import jdk.testlibrary.jfr.AllocationStackTrace;
 ...
 * @run main/othervm -XX:+UseConcMarkSweepGC -XX:MaxMetaspaceSize=64M jdk.jfr.event.gc.stacktrace.TestMetaspaceConcMarkSweepGCAllocationPendingStackTrace
 */
