...
import jdk.testlibrary.jfr.OldObjects;
import jdk.testlibrary.jfr.oldobject.TestClassLoader;
 ...
 * @run main/othervm -XX:TLABSize=2k -XX:FlightRecorderOptions=old-object-queue-size=10240 jdk.jfr.event.oldobject.TestObjectDescription
 */
