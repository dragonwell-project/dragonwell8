...
public final class TestActiveSettingEvent {
    ...
    public static void main(String[] args) throws Throwable {
        //testDefaultSettings();; //guangyu.zgy fix me
        //testProfileSettings();;
        testNewSettings();
        testChangedSetting();
        testUnregistered();
    ...
    private static void testSettingConfiguration(String configurationName) throws Exception {
        ...
        // pass.
        settingValues.put("com.oracle.jdk.ActiveSetting#stackTrace", "false");
        settingValues.put("com.oracle.jdk.ActiveSetting#threshold", "0 ns");
        settingValues.put("com.oracle.jdk.ActiveRecording#stackTrace", "false");
        settingValues.put("com.oracle.jdk.ActiveRecording#threshold", "0 ns");
        settingValues.put("com.oracle.jdk.JavaExceptionThrow#threshold", "0 ns");
        settingValues.put("com.oracle.jdk.JavaErrorThrow#threshold", "0 ns");
