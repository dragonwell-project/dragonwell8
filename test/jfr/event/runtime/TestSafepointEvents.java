 ...
 * @run main/othervm -Xbootclasspath/a:. -XX:+PrintJFRLog
 *                   -XX:+FlightRecorder -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI -XX:+EnableJFR
 *                   jfr.event.runtime.TestSafepointEvents
 */
