...
public class AllocationStackTrace {
    ...
    public static void testDefNewAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testDefNewAllocEvent"
        };
    ...
    public static void testMarkSweepCompactAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testMarkSweepCompactAllocEvent"
        };
    ...
    public static void testMetaspaceSerialGCAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testMetaspaceSerialGCAllocEvent"
        };
    ...
    public static void testParNewAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testParNewAllocEvent"
        };
    ...
    public static void testConcMarkSweepAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testConcMarkSweepAllocEvent"
        };
    ...
    public static void testMetaspaceConcMarkSweepGCAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testMetaspaceConcMarkSweepGCAllocEvent"
        };
    ...
    public static void testParallelScavengeAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testParallelScavengeAllocEvent"
        };
    ...
    public static void testParallelMarkSweepAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testParallelMarkSweepAllocEvent"
        };
    ...
    public static void testMetaspaceParallelGCAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testMetaspaceParallelGCAllocEvent"
        };
    ...
    public static void testG1YoungAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testG1YoungAllocEvent"
        };
    ...
    public static void testG1OldAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testG1OldAllocEvent"
        };
    ...
    public static void testMetaspaceG1GCAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testMetaspaceG1GCAllocEvent"
        };
    ...
    public static void testG1HumonAllocEvent() throws Exception {
        ...
        String[] expectedStack = new String[]{
            "jdk.testlibrary.jfr.AllocationStackTrace.testAllocEvent",
            "jdk.testlibrary.jfr.AllocationStackTrace.testG1HumonAllocEvent"
        };
