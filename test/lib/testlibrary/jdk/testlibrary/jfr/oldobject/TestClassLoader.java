...
package jdk.testlibrary.jfr.oldobject;
...
public final class TestClassLoader extends ClassLoader {
    ...
    public List<Class<?>> loadClasses(int count) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            String className = "jdk.testlibrary.jfr.oldobject.TestClassLoader$";
    ...
    private static byte[] readTestClassBytes() {
        try {
            String classFileName = "jdk/testlibrary/jfr/oldobject/TestClassLoader$TestClass0000000.class";
